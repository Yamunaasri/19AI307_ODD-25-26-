...
## AIM:
To write a Java program demonstrating Composition and Abstract Factory Pattern by creating related objects (Car and Bike) without specifying their concrete classes.
...
## RESULT:
Thus, the program using Composition and Abstract Factory Pattern was successfully implemented and executed to create related objects (Car and Bike) without specifying their concrete classes.
